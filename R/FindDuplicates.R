...
FindDuplicates <- function(data.object, 
                           ...
                           cut.odors      = F,          # remove everything beyond 4 letters from the odor names
                           conc.from.bc   = F,          # read concentration from barcode -- !!handle with care!!
                           conc.from.odor = F           # read concentration from odorfield, assuming is is the last 2 digits -- !!!handle with even more care!!!
                           )
{
